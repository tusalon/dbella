...
const CACHE_NAME = 'dbella-v49';
const urlsToCache = [
  '/dbella/',
  '/dbella/index.html',
  '/dbella/admin.html',
  '/dbella/admin-login.html',
  '/dbella/calendar.html',
  ...
  '/dbella/vendor/react.production.min.js',
  '/dbella/vendor/react-dom.production.min.js',
  '/dbella/vendor/babel.min.js',
  '/dbella/vendor/bcrypt.min.js',
  '/dbella/vendor/tailwind-browser.js',
  '/dbella/vendor/lucide/lucide.css',
  '/dbella/vendor/lucide/lucide.woff2',
  '/dbella/utils/push-config.js',
  '/dbella/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/dbella/icons/icon-192x192.png',
    badge: '/dbella/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/dbella/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/dbella/admin.html';
  event.waitUntil(
